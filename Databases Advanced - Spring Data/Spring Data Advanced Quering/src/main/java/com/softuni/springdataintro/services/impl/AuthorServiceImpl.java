...
public class AuthorServiceImpl implements AuthorService {
    ...
    @Override
    public List<Author> findAuthorsByLastNameStartsWith(String text) {
        return this.authorRepository.findAuthorsByLastNameStartsWith(text);
    }

    @Override
    public List<Author> findAllByFirstNameEndingWith(String text) {
        return this.authorRepository.findAllByFirstNameEndsWith(text);
